...
$_SERVER["REQUEST_METHOD"] == "POST";
    ...
    $sql = "UPDATE transfer_viajeros SET nombre = :nombre, email = :email, password = $hashedPassword, id_viajero = :id_viajero";

    // Preparar la consulta
    $stmt = $pdo->prepare($sql);

    // Vincular los parámetros
    $stmt->bindParam(':id_viajero', $id_viajero, PDO::PARAM_INT);
