...
///////////////////////////////// FILTRADO DE RESERVAS POR EMAIL /////////////////////////////////////
// Definir una variable para almacenar el correo electrónico del viajero
$email_cliente = '';

// Definir una variable para almacenar las reservas filtradas por correo electrónico del viajero
$reservas_filtradas = [];

// Si se ha enviado el formulario con el correo electrónico del viajero
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    // Obtener el correo electrónico del viajero ingresado
    $email_cliente = $_POST['email_cliente'];

    // Verificar si el correo electrónico del viajero no está vacío
    if (!empty($email_cliente)) {
        // Preparar la consulta SQL con una cláusula WHERE para filtrar por correo electrónico del viajero
        $stmt = $pdo->prepare("SELECT * FROM transfer_reservas WHERE email_cliente = :email_cliente");

        // Ejecutar la consulta con el correo electrónico del viajero ingresado
        $stmt->execute(['email_cliente' => $email_cliente]);

        // Obtener todas las filas de resultado
        $reservas_filtradas = $stmt->fetchAll(PDO::FETCH_ASSOC);
    }
}
...
<body>
    ...
    <div class="container-fluid page-header">
        <div class="container">
            <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 400px">
                <h3 class="display-4 text-white text-uppercase">Panel administrador</h3>
                <h4 class="text-white" >Realiza una reserva para tu cliente</h4>
            </div>
        </div>
    </div>
    <!-- Header End -->
    ...
    <!-- Booking Start -->
    <form action="registrar_reserva_admin.php" method="post">
                    ...
                    <div class="row align-items-center" style="min-height: 60px;">
                        <div class="col-md-10">
                            <div class="row">
                                ...
                                <div class="col-md-3" id="email_viajero" style="display: none;">
                                    <div class="mb-3 mb-md-0">
                                        <input type="text" class="form-control p-4" placeholder="Email del Viajero" name="email_cliente" required>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="mb-3 mb-md-0">
                                ...
                                <div class="col-md-3" id="fecha_entrada" style="display: none;">
                                    <div class="mb-3 mb-md-0">
                                        <input type="text" class="form-control p-4" placeholder="Fecha de Entrada" name="fecha_entrada">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3" id="origen_vuelo_entrada" style="display: none;">
                                    <div class="mb-3 mb-md-0">
                                        <input type="text" class="form-control p-4" placeholder="Origen vuelo entrada" name="origen_vuelo_entrada">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3" id="num_viajeros" style="display: none;">
                                    <div class="mb-3 mb-md-0">
                                        <input type="text" class="form-control p-4" placeholder="Número viajeros" name="num_viajeros" required>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="mb-3 mb-md-0">
    ...
    <script>
        function mostrarCampos(select) {
            ...
            if (reservaSeleccionada === '1') {
                ...
                document.getElementById('email_viajero').style.display = 'block';
    ...
    <div class="container py-5">
        <h2>Modifica o anular una reserva</h2>

    <!-- Formulario de búsqueda por correo electrónico del cliente -->
    <form action="panel_admin.php" method="post">
        <div class="row">
            <div class="col-md-3" id="email_viajero" style="display: block;">
                <div class="mb-3 mb-md-0">
                    <input type="text" class="form-control p-4" placeholder="Email del Cliente" name="email_cliente" required>
                </div><br>
            </div>
            <div class="col-md-2">
                <button class="btn btn-primary btn-block" type="submit" style="height: 47px; margin-top: -2px; display: block;" id='boton_submit'>Buscar</button>
                <br>
            </div>
        </div>
    </form>
    ...
    <!-- Resultados de la búsqueda de reservas -->
    <div class="row">
        <div class="col-lg-8">
            <div class="row pb-3">
                <div class="col-md-6 mb-4 pb-2">
                    <div class="blog-item">
                        <?php if(empty($reservas_filtradas)): ?>
                            <p>No hay reservas que mostrar para el correo electrónico <?php echo $email_cliente; ?>.</p>
                        <?php else: ?>    
                            <?php foreach ($reservas_filtradas as $reserva): ?>
                                ...
                                <div class="bg-white p-4">
                                    ...
                                    <a class="h5 m-0 text-decoration-none"><?php echo $reserva['origen_vuelo_entrada']; ?></a><br>
                                    <!-- Botón "Modificar / Cancelar" -->
                                    <form action="modificar_reserva_admin.php" method="post">
